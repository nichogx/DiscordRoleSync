...
## [2.3.3](https://gitlab.com/nichogx/DiscordRoleSync/-/releases/2.3.3) - 2025-07-09
...
### Added
- Official support for 1.21.5

## [2.3.1](https://gitlab.com/nichogx/DiscordRoleSync/-/releases/2.3.1) - 2025-04-21
...
### Fixed
- Information about the latest plugin version for update notifications is now pulled from a more reliable API
